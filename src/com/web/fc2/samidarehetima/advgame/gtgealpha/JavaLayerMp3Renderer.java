...
//このプログラムを動かすには，GTGE-0.2.3.jar(GTGE本体)とjl1.0.jar(JavaLayler)が必要．
/**
...
public class JavaLayerMp3Renderer extends BaseAudioRenderer
{
    ...
    public int getStatus()
    {
        if (this.player != null)
        {
            ...
            return (this.player.isComplete()) ? BaseAudioRenderer.END_OF_SOUND : super.getStatus();
        }
...
//
//        String music1 = "file:///home/samidare/BGM/pia-no-jac/crossbeat.mp3";
//        String music2 = "file:///home/samidare/BGM/MyleneFarmer/MyleneFarmer1_silence_01.mp3";
//
//        if (args != null)
//        {
//            if (args.length >= 1)
